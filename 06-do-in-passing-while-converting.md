...
在这一章中，我们将学到许多具有各种功能的[命令行选项](03-execute.md#选项与参数)，这些选项都需要加在整条命令的输出文件名之前。

万变不离其宗，在前面介绍的[查看帮助](03-execute.md#查看帮助)一节中学到的 `ffmpeg -help` 命令仍然是非常实用的，本章也将一直围绕它的输出来进行。所以，在开始阅读第一节之前，先打开终端，执行一下 `ffmpeg -help` 吧！
...
其实这个选项我们在[第 5 章第 2 节](05-start-converting.md#指定编码器)的最后已经讲过了，不过我觉得有必要再做一次详细的说明。
...
看完了这些说明，我想你就应该能够熟练地掌握命令行的规则了。而在接下来的[下一章](07-subtitles.md)中，我们将会介绍有关字幕的东西。
